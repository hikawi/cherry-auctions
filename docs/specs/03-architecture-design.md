...
| `opensearch.cherry-auctions.luny.dev` | OpenSearch Dashboards | Restricted   | Internal dashboard for log analysis and monitoring.          |
...
![Architecture Design version 2](../images/architecture_v2.png)
